                ...
                >
                  ...
                  >
                    ...
                    <div className="mt-8 flex items-center gap-3 pt-6 border-t border-border">
                      ...
                      <a
                        href={hasAgreed ? site.resumePath : undefined}
                        target={hasAgreed ? "_blank" : undefined}
                        rel={hasAgreed ? "noopener noreferrer" : undefined}
                        onClick={(e) => {
                          if (!hasAgreed) {
                            e.preventDefault()
                            return
                        ...
                        className={cn(
                          "flex-1",
                          hasAgreed
                            ? "btn-premium-primary min-h-[48px] inline-flex items-center justify-center gap-2"
